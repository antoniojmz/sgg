...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('theme/assets/css/color/color-2.css') }}" id="color"/>
  <link rel="stylesheet" type="text/css" href="{{ asset('theme/assets/css/color/color-3.css') }}" id="color"/>
  <link rel="stylesheet" type="text/css" href="{{ asset('theme/assets/css/color/color-4.css') }}" id="color"/>
  <link rel="stylesheet" type="text/css" href="{{ asset('theme/assets/css/color/color-5.css') }}" id="color"/>
...
{{ HTML::script('theme/assets/pages/dashboard.js') }}
  ...
  <section class="sidebar" id="sidebar-scroll">
    ...
    <ul class="sidebar-menu">
          ...
          <li class="col-md-3">
            <div class="card-block mega-card">
              ...
              <ul class="mega-list row">
                <li class="col-xs-12 col-xl-6">
                  <ul>
                    <li><a class="waves-effect waves-dark" href="menu-static.html" target="_blank"><i class="icon-arrow-right"></i> Static Layout</a></li>
                    <li><a class="waves-effect waves-dark" href="menu-fixed.html" target="_blank"><i class="icon-arrow-right"></i> Header and Sidebar Fixed</a></li>
                    <li><a class="waves-effect waves-dark" href="menu-sidebar-sticky.html" target="_blank"><i class="icon-arrow-right"></i> Sidebar Sticky</a></li>
                    <li><a class="waves-effect waves-dark" href="menu-header-fixed.html" target="_blank"><i class="icon-arrow-right"></i> Header Fixed</a></li>
                ...
                <li class="col-xs-12 col-xl-6">
                  <ul>
                    ...
                    <li><a class="waves-effect waves-dark" href="menu-footer-fixed.html" target="_blank"><i class="icon-arrow-right"></i> Footer Fixed</a></li></li>
      ...
      <li class="treeview"><a href="#"><i class="icon-present"></i><span> Extras </span><i class="icon-arrow-down"></i></a>
        <ul class="treeview-menu">
          <li class="treeview"><a href="#"><i class="icon-arrow-right"></i><span>  Social </span><i class="icofont icofont-caret-right"></i></a>
            <ul class="treeview-menu">
          ...
          <li class="treeview"><a href="#"><i class="icon-arrow-right"></i><span>  Email Template </span><i class="icofont icofont-caret-right"></i></a>
            <ul class="treeview-menu">
          ...
          <li><a class="waves-effect waves-dark" href="full-calender.html"><i class="icon-arrow-right"></i>Full Calender<span class="label label-danger menu-caption">Hot</span></a>
                        <li><a class="waves-effect waves-dark" href="Change-loges.html"><i class="icon-arrow-right"></i>Change log<span class="label label-danger menu-caption">5</span></a></li></li>
        </ul>
      </li>
      ...
      <li class="treeview"><a href="#"><i class="icofont icofont-company"></i><span> Menu Level 1 </span><i class="icon-arrow-down"></i></a>
        <ul class="treeview-menu">
          ...
          <li class="treeview"><a href="#"><i class="icon-arrow-right"></i><span>  Level Two </span><i class="icofont icofont-caret-right"></i></a>
            <ul class="treeview-menu">
              <li><a href="#!"><i class="icon-arrow-right"></i> Level Three</a>
              </li>
              <li class="treeview"><a href="#"><i class="icon-arrow-right"></i><span>  Level Three </span><i class="icofont icofont-caret-right"></i></a>
                <ul class="treeview-menu">
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="col-sm-12 card">
                        <div class="card-block">
                            <h6 class="m-b-20">Website Status</h6>
                            <div id="website-status" style="height: 420px"></div>
                        </div>
