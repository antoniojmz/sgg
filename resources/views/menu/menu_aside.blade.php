<aside class="main-sidebar hidden-print ">
  <section class="sidebar" id="sidebar-scroll">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview"><a href="#"><i class="icon-speedometer"></i><span>  Dashboard </span><i class="icon-arrow-down"></i></a>
      ...
      <li class="active treeview"><a href="#"><i class="icon-user-follow"></i><span>  Components  </span><i class="icon-arrow-down"></i></a>
              ...
              <ul class="mega-list row">
                <li class="col-xs-12 col-md-6">
                  <ul>
                    ...
                    <li class="h-active"><a class="waves-effect waves-dark" href="contact-details.html"><i class="icon-arrow-right"></i> Contact Details</a></li>
